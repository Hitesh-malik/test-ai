    ...
    >
      ...
      <motion.div variants={containerVariants} className="space-y-3 mb-6">
        <motion.button
          ...
          className="w-full flex items-center justify-center px-6 py-3 bg-white bg-opacity-10 hover:bg-opacity-20 text-white font-medium rounded-xl border border-white border-opacity-20 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        >
          ...
          <span>{socialLoading.github ? 'Signing in...' : 'Continue with GitHub'}</span>
        </motion.button>
      </motion.div>
